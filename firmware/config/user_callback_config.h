...
#if (BLE_CSC_SENSOR)
static const struct app_cscps_cb user_app_cscps_cb = {
    .on_cscps_enable_rsp         = NULL,
    .on_cscps_meas_cfm           = NULL,
    .on_cscps_sc_cntl_pt_req_ind = NULL,
    .on_cscps_cfg_ntfind_ind     = user_on_cscps_cfg_ntfind_ind,
};
#endif
